...
### 이재상
### 뉴스요약 gpt의 성능발전과 인공지능의 발전으로 인한 인간에게 미치는 영향에 대한 내용


###느낀점
인공지능의 발전이 굉장히 빠르다는것을 이 기사를 읽으면서 다시 한번 실감 하게 되었고 단층퍼셉트론에서 벗어나 다층퍼셉트론이 나오고 딥러닝 기법이 창시되며 컴퓨팅성능의 폭발적인 성장으로 이제는 
컴퓨터가 사람처럼 추론을 할 수 있는 시대가 왔다는것이 정말 신기하고 인공지능이 진로인 사람으로서 되게 흥미가있고 인공지능이 어디까지 발전 할 수 있을지도 궁금하다. 
